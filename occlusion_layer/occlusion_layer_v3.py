...
class OcclusionLayer(nn.Module):
    def __init__(self, image, first_layer, is_cnn=False):
        ...
        self.fc4 = OcclusionFourthLayer(size_in=self.fc3.size_out, size_out=image_channel * image_width * image_height, image=image, model_first_layer=first_layer, is_cnn=is_cnn)
...
class OcclusionThirdLayer(nn.Module):
    ...
    def init_weights_bias(self, size_in, size_out, image_shape):
        ...
        bias[block_size:] = -torch.ones(block_size) * 2
